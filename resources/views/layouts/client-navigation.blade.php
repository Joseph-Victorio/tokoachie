<nav x-data="{ open: false }" class="relative z-50">
  <div class="m-5 p-5 font-sansita text-secondary flex justify-between items-center">
    ...
    <div>
     ...
     <a href="#" class="md:hidden"><img src="{{ asset('/gambar/shopping_cart.svg') }}" alt="keranjang belanja" class="w-8"></a>   
    ...
    <div class="hidden sm:flex space-x-8 text-secondary bg-primary rounded-2xl justify-center items-center px-10 py-2">
    ...
    <div class="hidden sm:flex gap-2 items-center">
      <a href="#"><img src="{{ asset('/gambar/shopping_cart.svg') }}" alt="keranjang belanja" class="w-7"></a>
      <div class="bg-primary px-5 py-2 rounded-2xl">
        <a href="https://wa.me/628989000007" class="flex gap-1 items-center">
